...
const addRow = function (i) {
    var htmlElenent = `<tr>
                    ...
                    <td><input type="number"  class="form-control Price" name="Details[${i}].Price"/></td>
                    <td><input type="number"  class="form-control Quantity" name="Details[${i}].Quantity"/></td>
                    <td><input type="number"  class="form-control Discount" placeHolder="                           %" name="Details[${i}].Discount"/></td>
                    <td><input type="number"  class="form-control Total" readonly name="Details[${i}].Total"/></td>
                    <td>
